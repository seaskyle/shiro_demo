            ...
            <ul class="list-unstyled">
                ...
                <li class="active"><a href="#elements" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-globe"></i>UI Elements </a>
                    <ul id="elements" class="collapse list-unstyled">
                        ...
                        <li class="active"><a href="ui-cards.html">Cards</a></li> 
            ...
            <div class="row" id="card-2">
                <div class="col-lg-3 col-sm-6">
                    <div class="card hovercard">
                        ...
                        <div class="avatar">
                            <img alt="" src="${base}/bootstrap/img/avatar-1.jpg">
                        </div>
                        <div class="info">
                            <div class="title">
                        ...
                        <div class="bottom">
                            <a class="btn btn-info btn-twitter btn-sm" href="https://twitter.com/webmaniac">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card hovercard">
                        <div class="cardheader"></div>
                        <div class="avatar">
                            <img alt="" src="${base}/bootstrap/img/avatar-2.jpg">
                        </div>
                        <div class="info">
                            <div class="title">
                                <a target="_blank" href="#">Trill Eden</a>
                            </div>
                            <div class="desc">Passionate designer</div>
                            <div class="desc">Curious developer</div>
                            <div class="desc">Tech geek</div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card hovercard">
                        <div class="cardheader"></div>
                        <div class="avatar">
                            <img alt="" src="${base}/bootstrap/img/avatar-3.jpg">
                        </div>
                        <div class="info">
                            <div class="title">
                                <a target="_blank" href="#">Treen Lan</a>
                            </div>
                            <div class="desc">Passionate designer</div>
                            <div class="desc">Curious developer</div>
                            <div class="desc">Tech geek</div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card hovercard">
                        <div class="cardheader"></div>
                        <div class="avatar">
                            <img alt="" src="${base}/bootstrap/img/avatar-4.jpg">
                        </div>
                        <div class="info">
                            <div class="title">
                                <a target="_blank" href="#">Jefer Drin</a>
                            </div>
                            <div class="desc">Passionate designer</div>
                            <div class="desc">Curious developer</div>
                            <div class="desc">Tech geek</div>
            ...
            <div class="row mt-2" id="card-1">
                <div class="col-sm-6 col-md-4 col-lg-3 ">
                    <div class="card card-inverse card-info">
                        <img class="card-img-top" src="${base}/bootstrap/img/card/c-1.jpg">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 ">
                    <div class="card card-inverse card-info">
                        <img class="card-img-top" src="${base}/bootstrap/img/card/c-2.jpg">
                        <div class="card-block"> 
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 ">
                    <div class="card card-inverse card-info">
                        <img class="card-img-top" src="${base}/bootstrap/img/card/c-3.jpg">
                        <div class="card-block"> 
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 ">
                    <div class="card card-inverse card-info">
                        <img class="card-img-top" src="${base}/bootstrap/img/card/c-4.jpg">
                        <div class="card-block"> 
            ...
            <div class="row mt-2" id="card-3">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="panel panel-default panel-card">
                        ...
                        <div class="panel-figure">
                            <img class="img-fluid rounded-circle" src="https://s3.amazonaws.com/uifaces/faces/twitter/josue/73.jpg" />
                        </div>
                        <div class="panel-body text-center">
                            <h4 class="panel-header"><a href="https://twitter.com/maridlcrmn">Maridlcrmn</a></h4>
                            <small>A short description goes here.</small>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="panel panel-default panel-card">
                        ...
                        <div class="panel-figure">
                            <img class="img-fluid rounded-circle" src="https://s3.amazonaws.com/uifaces/faces/twitter/mutlu82/73.jpg" />
                        </div>
                        <div class="panel-body text-center">
                            <h4 class="panel-header"><a href="https://twitter.com/maridlcrmn">Maridlcrmn</a></h4>
                            <small>A short description goes here.</small>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="panel panel-default panel-card">
                        ...
                        <div class="panel-figure">
                            <img class="img-fluid rounded-circle" src="https://s3.amazonaws.com/uifaces/faces/twitter/nisaanjani/73.jpg" />
                        </div>
                        <div class="panel-body text-center">
                            <h4 class="panel-header"><a href="https://twitter.com/maridlcrmn">Maridlcrmn</a></h4>
                            <small>A short description goes here.</small>
                    ...
                    <div class="weather-card rain">
                        <div class="top">
                            <div class="wrapper">
                                ...
                                <h3 class="location">California, USA</h3>
                                <p class="temp">
