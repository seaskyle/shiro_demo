...
<head>
    ...
    <!-- Core stylesheets -->
    <link rel="stylesheet" href="${base}/bootstrap/css/pages/search.css">
</head>
            ...
            <ul class="list-unstyled">
                ...
                <li class="active"><a href="#pages" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-file-o"></i>Pages </a>
                    <ul id="pages" class="collapse list-unstyled">
                        ...
                        <li class="active"><a href="search-result.html">Search Result</a></li> 
                    ...
                    <section class="col-xs-12 col-sm-6 col-md-12">
                        <article class="search-result row">
                            <div class="col-xs-12 col-sm-12 col-md-3">
                                <a href="#" title="Lorem ipsum" class="thumbnail"><img src="${base}/bootstrap/img/search/s-1.jpg" class="img-fluid" alt="Lorem ipsum" /></a>
                            </div>
                        ...
                        <article class="search-result row">
                            <div class="col-xs-12 col-sm-12 col-md-3">
                                <a href="#" title="Lorem ipsum" class="thumbnail"><img src="${base}/bootstrap/img/search/s-2.jpg" class="img-fluid" alt="Lorem ipsum" /></a>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-2">
                                <ul class="meta-search">
                        ...
                        <article class="search-result row">
                            <div class="col-xs-12 col-sm-12 col-md-3">
                                <a href="#" title="Lorem ipsum" class="thumbnail"><img src="${base}/bootstrap/img/search/s-3.jpg" class="img-fluid" alt="Lorem ipsum" /></a>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-2">
                                <ul class="meta-search">
