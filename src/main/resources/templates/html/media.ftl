...
<head>
    ...
    <link rel="stylesheet" href="${base}/bootstrap/css/magnific-popup/magnific-popup.css">
    <link rel="stylesheet" href="${base}/bootstrap/css/style.default.css" id="theme-stylesheet">

    <!-- Core stylesheets -->
    <link rel="stylesheet" href="${base}/bootstrap/css/apps/media.css">
</head>
...
======================================================-->
                 ...
                 <div class="row no-gutters">
                    <div class="col-md-4 col-sm-4">
                        <div class="img-wrapper">
                            <a href="${base}/bootstrap/img/work/1.jpg" title="Work Description Goes Here">
                                <img src="${base}/bootstrap/img/work/1.jpg" class="img-fluid" alt="Work">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="img-wrapper">
                            <a href="${base}/bootstrap/img/work/2.jpg" title="Work Description Goes Here">
                                <img src="${base}/bootstrap/img/work/2.jpg" class="img-fluid" alt="Work">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="img-wrapper">
                            <a href="${base}/bootstrap/img/work/3.jpg" title="Work Description Goes Here">
                                <img src="${base}/bootstrap/img/work/3.jpg" class="img-fluid" alt="Work">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="img-wrapper">
                            <a href="${base}/bootstrap/img/work/4.jpg" title="Work Description Goes Here">
                                <img src="${base}/bootstrap/img/work/4.jpg" class="img-fluid" alt="Work">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="img-wrapper">
                            <a href="${base}/bootstrap/img/work/5.jpg" title="Work Description Goes Here">
                                <img src="${base}/bootstrap/img/work/5.jpg" class="img-fluid" alt="Work">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="img-wrapper">
                            <a href="${base}/bootstrap/img/work/6.jpg" title="Work Description Goes Here">
                                <img src="${base}/bootstrap/img/work/6.jpg" class="img-fluid" alt="Work">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="img-wrapper">
                            <a href="${base}/bootstrap/img/work/7.jpg" title="Work Description Goes Here">
                                <img src="${base}/bootstrap/img/work/7.jpg" class="img-fluid" alt="Work">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="img-wrapper">
                            <a href="${base}/bootstrap/img/work/8.jpg" title="Work Description Goes Here">
                                <img src="${base}/bootstrap/img/work/8.jpg" class="img-fluid" alt="Work">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
    ...
    <script src="${base}/bootstrap/js/magnific-popup/jquery.magnific-popup.min.js"></script>
    <script>
        $(function () {
            $("#work").magnificPopup({
