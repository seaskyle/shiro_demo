...
<head>
    ...
    <!-- Core stylesheets -->
    <link rel="stylesheet" href="${base}/bootstrap/css/pages/gallery.css">
</head>
        ...
        <div class="content-inner chart-cont">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 mt-1">
                    <div class="box-4">
                        <img src="${base}/bootstrap/img/gallery/g-2.jpg">
                ...
                <div class="col-md-4 col-sm-6 mt-1">
                    <div class="box-4">
                        <img src="${base}/bootstrap/img/gallery/g-1.jpg">
                        <div class="box-4-content">
                            <h3 class="title">Williamson</h3>
                            <ul class="icon">
                                <li><a href="#"><i class="fa fa-search"></i></a></li>
                ...
                <div class="col-md-4 col-sm-6 mt-1">
                    <div class="box-4">
                        <img src="${base}/bootstrap/img/gallery/g-3.jpg">
                        <div class="box-4-content">
                            <h3 class="title">Williamson</h3>
                            <ul class="icon">
                                <li><a href="#"><i class="fa fa-search"></i></a></li>
                ...
                <div class="col-md-4 col-sm-6 mt-4">
                    <div class="box-4">
                        <img src="${base}/bootstrap/img/gallery/g-4.jpg">
                        <div class="box-4-content">
                            <h3 class="title">Williamson</h3>
                            <ul class="icon">
                                <li><a href="#"><i class="fa fa-search"></i></a></li>
                ...
                <div class="col-md-4 col-sm-6 mt-4">
                    <div class="box-4">
                        <img src="${base}/bootstrap/img/gallery/g-5.jpg">
                        <div class="box-4-content">
                            <h3 class="title">Williamson</h3>
                            <ul class="icon">
                                <li><a href="#"><i class="fa fa-search"></i></a></li>
                ...
                <div class="col-md-4 col-sm-6 mt-4">
                    <div class="box-4">
                        <img src="${base}/bootstrap/img/gallery/g-6.jpg">
                        <div class="box-4-content">
                            <h3 class="title">Williamson</h3>
                            <ul class="icon">
                                <li><a href="#"><i class="fa fa-search"></i></a></li>
                ...
                <div class="col-md-4 col-sm-6 mt-4">
                    <div class="box-4">
                        <img src="${base}/bootstrap/img/gallery/g-7.jpg">
                        <div class="box-4-content">
                            <h3 class="title">Williamson</h3>
                            <ul class="icon">
                                <li><a href="#"><i class="fa fa-search"></i></a></li>
